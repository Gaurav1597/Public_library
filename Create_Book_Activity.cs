    ...
    public class Create_Book_Activity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            ListView1= FindViewById<ListView>(Resource.Id.listView1);
             ...
             dpPath = Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal), "books.sqlite");
        ...
        // }
        public void Insert(Tbl_Books tbl_Books)
        {
            db.Insert(tbl_Books);
        }

        public void Update(Tbl_Books tbl_Books)
        {
            db.Update(tbl_Books);
        }

        public void Delete(Tbl_Books tbl_Books)
        {
            db.Delete(tbl_Books);
        }
        ...
        private void load_spiner_category()
        {
           ...
           Resources.Adpter_Books_Category_List  da = new Resources.Adpter_Books_Category_List(this, List_All_Category);
            spinnershowcategory.Adapter = (ISpinnerAdapter)da;

        }

        private void load_spiner_books()
        {
            string dpPath = Path.Combine(Xamarin.Essentials.FileSystem.AppDataDirectory, "books.sqlite");
            var db = new SQLiteConnection(dpPath);
            var data_s = db.Query<Tbl_Books>("select *  from Tbl_Books where Cid=" + txtcategoryid .Text);
            List_All_Books = data_s;
            Resources.Adpter_Books da = new Resources.Adpter_Books(this, List_All_Books);
            spinnershowbook.Adapter = (ISpinnerAdapter)da;
            ListView1.Adapter = (IListAdapter)da;
        }
    }
}